 1. You are given two 32-bit numbers, N andM, and two bit positions, i and j. Write a
...
2.     Given a real number between 0 and 7 (e.g., 0.72) that is passed in as a double, print
...
3.        longest sequence
 ...
 4.  Given a positive integer, print the next smallest and the next largest number that
     have the same number of 1 bits in their binary representation



6.      Write a function to determine the number of bits required to convert integer A to
        integer B.
        
        
        
 7.    Write a program to swap odd and even bits in an integer with as few instructions as
        possible (e.g., bit 0 and bit! are swapped, bit 2 and bit 3 are swapped, and so on)        
        
        
        
8.      A monochrome screen is stored as a single array of bytes, allowing eight consecutive
